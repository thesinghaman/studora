...
class ReportFoundItemView extends GetView<ReportFoundItemController> {
        ...
        Obx(
          () => TextFormField(
            ...
            controller: TextEditingController(
              text: controller.foundDate.value == null
                  ? ""
                  : DateFormat('MMM d, yy').format(controller.foundDate.value!),
            ),
            decoration: InputDecoration(
            ...
            onTap: () => controller.pickFoundDate(context),
            validator: (value) => controller.foundDate.value == null
      ...
      children: [
        ...
        Obx(
          () => TextFormField(
            readOnly: true,
            controller: TextEditingController(
              text: controller.foundTime.value == null
                  ? ""
                  : controller.foundTime.value!.format(context),
            ),
            decoration: InputDecoration(
            ...
            onTap: () => controller.pickFoundTime(context),
            style: theme.textTheme.bodyLarge,
          ),
        ),
      ],
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              _buildTextFormField(
                ...
                hint: "e.g., Blue Water Bottle, Set of Keys",
                validator: (value) =>
              ...
              _buildTextFormField(
                ...
                label: "Description*",
                hint:
                    "Provide details like color, brand, any distinguishing features...",
                maxLines: 4,
                validator: (value) =>
              ...
              _buildTextFormField(
                ...
                validator: (value) =>
                    InputValidators.validateNotEmpty(value, "Location Found"),
              ),
              const SizedBox(height: 16.0),
              Row(
                children: [
              ...
              _buildTextFormField(
                context: context,
                controller: controller.foundDetailsController,
                label: "Any specific details or where it's kept? (Optional)",
                hint:
                    "e.g., Found near library entrance, kept at security desk",
                maxLines: 2,
              ),
              Padding(
                padding: const EdgeInsets.only(top: 4.0, left: 2.0),
                child: Text(
                  "This information can help in reuniting the item with its owner.",
                  style: theme.textTheme.bodySmall?.copyWith(
                    color: theme.colorScheme.onSurfaceVariant,
                  ),
                ),
              ...
              Obx(
                () => controller.isLoading.value
                    ...
                    : ElevatedButton.icon(
                        icon: const Icon(CupertinoIcons.flag_fill, size: 20),
                        label: const Text("Report as Found"),
                        ...
                        onPressed: controller.submitReportFoundItem,
                      ),
              ),
